...
<div class="grid_10">
	<div class="box round first grid">
		...
		<?php 
			...
			{
				$seenid = $_GET['seenid'];
				$query = "UPDATE contacttbl	SET	status = '1' WHERE id = '$seenid'";
		...
		if (isset($_GET['delid'])) {
		$delid = $_GET['delid'];
		$delquery = "delete from contacttbl where id = '$delid'";
	...
	<div class="block">        
		...
		<tbody>
			...
			<?php
				...
				$query = "select * from contacttbl where status='1' order by id desc";
				$msg = $db->select($query);
				if ($msg) {
